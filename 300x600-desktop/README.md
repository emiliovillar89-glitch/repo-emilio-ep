# Banner HTML 300x600 Desktop - Penca Antel Ovación
...
Abrí `300x600-desktop/index.html` en un navegador o servilo con un servidor estático desde la carpeta `300x600-desktop`:
